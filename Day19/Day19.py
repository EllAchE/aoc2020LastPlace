...
data, messages = tuple(map(lambda x: x.splitlines(), open('input.txt').read().split('\n\n')))
...
stack = list(reversed(rules[0][0]))

print("Part 1:", process_messages(stack))
rules[8] = [[42], [42, 8]]
rules[11] = [[42, 31], [42, 11, 31]]
print("Part 2:", process_messages(stack))
