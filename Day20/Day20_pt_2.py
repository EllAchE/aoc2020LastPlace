...
class Tile:
    ...
    def left_match(self, match_id):
        self.left_match_id = match_id

    def right_match(self, match_id):
        self.right_match_id = match_id

    def top_match(self, match_id):
        self.top_match_id = match_id

    def bottom_match(self, match_id):
        self.bottom_match_id = match_id
